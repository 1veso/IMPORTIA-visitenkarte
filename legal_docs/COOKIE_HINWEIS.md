...
## Empfehlung für die Importia-Site

**Variante A (empfohlen für jetzt): KEIN Cookie-Banner**

Solange die Site rein statisch ist, keine Drittanbieter-Skripte lädt, keine Webfonts extern lädt, keine Embeds enthält und kein Tracking nutzt, ist ein Cookie-Banner rechtlich nicht erforderlich und sogar UX-schädlich (jeder zusätzliche Banner reduziert Conversion und stört die Premium-Wahrnehmung).
...
Falls in Zukunft Tracking-Tools eingebaut werden, hier der Vorlage-Text für einen rechtskonformen Consent-Banner:
